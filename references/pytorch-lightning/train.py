...
def main():
    ...
    tb_logger = pl.loggers.TensorBoardLogger("tb_logs", name="mnist", default_hp_metric=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cuda", action="store_true", help="Whether to use CUDA for training.")
